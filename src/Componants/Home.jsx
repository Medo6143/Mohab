...
import cv from "../Mohab_inf/CV.pdf";
import { FaFacebook, FaGithub, FaLinkedin, FaWhatsapp } from "react-icons/fa";
import url from "../Mohab_inf/mohab.png";
export const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className=" mt-4 justify-center flex flex-col items-center gap-4 ">
          ...
          <ul className="flex gap-4">
            ...
            <li className="cur cursor-pointer hover:text-[#32D3FF]">
              <a target="blank" href="https://wa.me/201015977091">
                <FaWhatsapp size={25} />
              </a>
            </li>
          </ul>
      ...
      <div
        data-aos="fade-down"
        className="bg-black hove sm:w-[330px] w-5/6 h-[75%]  mt-7  borderAnimation rounded-3xl "
      >
        <img
          src={url}
          alt="Mohab img"
